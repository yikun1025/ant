...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # BEGIN Problem 8
        if self.place.ant is None and self.place.ant.blocks_path is True:
            return True
        # END Problem 8
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        nearest_place = None
        transitions = 0
        while check_place.name != 'Hive' and nearest_place is None and transitions <= self.max_range:
...
class HungryAnt(Ant):
    ...
    def action(self, colony):
        # BEGIN Problem 10
        if self.disgesting == 0 and self.place.bees is not None:
            self.eat_bee(self, self.place.bees)
            self.disgesting += 1
            if self.disgesting == 3:
                self.disgesting = 0
        # END Problem 10
